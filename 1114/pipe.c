...
void main(int ac, char *av[])
{
	...
	// thepipe[0] refers to the read end of the pipe.  
	// thepipe[1] refers to the write end of the pipe.
	...
	// we don't need else statement here because
	// A successful exec call replaces the current process with another process

	// child executes av[1] and writes into pipe
	close( thepipe[0] );		// children doesn't read from pipe
